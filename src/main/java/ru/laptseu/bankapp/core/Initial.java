...
public class Initial {
    ...
    public void startApp() {
        ...
        //todo ask. я бы как-то вложил сюда возможность при вводе "Команды" и "выход"
        // выходить в начало в дальнейшем. мне кажется, сделать это можно через тригер на
        // эти команды в кажмом      свитче
